! function (n, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t(n.topojson = {})
}(this, function (n) {
    "use strict";
    ...
    function r(n) {
        ...
        var r, e, o = n.scale[0],
            ...
            f = n.translate[1];
        return function (n, t) {
            t || (r = e = 0), n[0] = (r += n[0]) * o + u, n[1] = (e += n[1]) * i + f
        }
    }
    ...
    function l(n, t, r) {
        ...
        function u(n) {
            "GeometryCollection" === n.type ? n.geometries.forEach(u) : n.type in l && (c = n, l[n.type](n.arcs))
        }
        var f = [];
        if (arguments.length > 1) {
            ...
            u(t), s.forEach(arguments.length < 3 ? function (n) {
                f.push(n[0].i)
            } : function (n) {
    ...
    function g(n) {
        return c(n, v.apply(this, arguments))
    }
    ...
    function v(n, t) {
        ...
        return t.forEach(function (n) {
            ...
            if (!n._) {
                var t = [],
                    r = [n];
                for (n._ = 1, u.push(t); n = r.pop();) t.push(n), n.forEach(function (n) {
            ...
            arcs: u.map(function (t) {
                ...
                if (t.forEach(function (n) {
                    ...
                    }), i = a(n, i), (r = i.length) > 1)
                    for (var u, f = e(t[0][0]), c = 0; r > c; ++c)
                        if (f === e(i[c])) {
                            u = i[0], i[0] = i[c], i[c] = u;
                            break
                        } return i
        ...
        for (var c in o)
            for (var a = o[c], s = a.length, l = 0; s > l; ++l)
                for (var h = l + 1; s > h; ++h) {
                    var p, g = a[l],
                        v = a[h];
                    (p = u[g])[c = i(p, v)] !== v && p.splice(c, 0, v), (p = u[v])[c = i(p, g)] !== g && p.splice(c, 0, g)
                }
        return u
    }
    ...
    var _ = "1.6.24";
    n.version = _, n.mesh = s, n.meshArcs = l, n.merge = g, n.mergeArcs = v, n.feature = u, n.neighbors = y, n.presimplify = E
});